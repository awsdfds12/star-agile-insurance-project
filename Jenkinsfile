node{
    ...
    stage('git code checkout'){
        try{
            ...
            git 'https://github.com/awsdfds12/star-agile-insurance-project.git'
        }
        catch(Exception e){
    ...
    stage('Containerize the application'){
        ...
        sh "${dockerCMD} build -t krishtonnaik1/insure-me:${tagName} ."
    }
    ...
    stage('Pushing it ot the DockerHub'){
        ...
        sh "${dockerCMD} push krishtonnaik1/insure-me:${tagName}"
